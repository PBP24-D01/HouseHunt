...
from wishlist.views import wishlist_json, delete_wishlist_flutter, edit_wishlist_flutter, add_wishlist_flutter
...
urlpatterns = [
    ...
    path('wishlist/add-flutter/<int:id_rumah>/', add_wishlist_flutter, name='add_wishlist_flutter'),
]